...
--
-- 적용 후 반드시 로그인/예약/강사 투어관리/리뷰작성/신고/문의/쿠폰/센터/고객센터/채팅/
-- 관리자 화면을 한 번씩 테스트해주세요.
...
where schemaname = 'public'
  and tablename in (
    'tours','bookings','reviews','reports','inquiries','coupons','instructors',
    'centers','support_tickets','penalties_log','chat_messages',
    'qa_checklist_results','deleted_accounts'
  )
