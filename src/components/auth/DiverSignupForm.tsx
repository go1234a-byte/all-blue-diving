  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <label className="flex items-start gap-2 text-xs text-muted-foreground">
        ...
        />
        <span>
          본인은 ALL BLUE를 이용이 제한되는 카테고리(음란물, 도박, 불법 대출 등), 금지된 내용, 금지된 행동과 관련된
          운영정책을 위반하는 목적으로 이용하지 않을 것을 확인합니다. ALL BLUE는{" "}
          <b>불쾌감을 주는 콘텐츠와 악의적 이용자에 대해 무관용 원칙</b>을 적용하며, 신고 접수 시 24시간 이내에 해당
          콘텐츠를 삭제하고 이용자를 서비스에서 배제합니다. (필수)
        </span>
      </label>
