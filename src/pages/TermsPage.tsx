        ...
        <div className="space-y-8 text-sm leading-relaxed text-foreground">
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold">
              제8조의2 (이용자 생성 콘텐츠 및 불쾌감을 주는 콘텐츠·악성 이용자 무관용 정책)
            </h2>
            <ol className="list-decimal space-y-1 pl-5">
              <li>
                회사는 그룹채팅, 후기, 문의 등 회원이 작성·게시하는 콘텐츠(이하 &ldquo;이용자 생성 콘텐츠&rdquo;)에 대해
                <b> 불쾌감을 주는 콘텐츠와 악의적 이용자에 대한 무관용(zero tolerance) 원칙</b>을 적용합니다.
              </li>
              <li>
                다음 각 호의 콘텐츠 또는 행위는 전면 금지됩니다: 욕설·비하·혐오 표현, 성적·폭력적·불법적 내용, 타인에 대한
                괴롭힘·협박·스토킹, 개인정보 무단 게시, 스팸·광고, 사칭.
              </li>
              <li>
                회사는 자동 필터를 통해 명백히 부적절한 표현의 게시를 사전에 차단하며, 회원은 모든 후기와 채팅 메시지에 대해
                <b> 신고(flag)</b> 및 해당 이용자 <b>차단(block)</b> 기능을 이용할 수 있습니다. 차단 시 해당 이용자의 콘텐츠는
                즉시 이용자의 화면에서 제거되며, 그 사실이 운영팀에 통지됩니다.
              </li>
              <li>
                회사는 신고를 접수한 때로부터 <b>24시간 이내</b>에 해당 콘텐츠를 검토하여 위반이 확인되면 콘텐츠를 삭제하고,
                콘텐츠를 게시한 이용자의 서비스 이용을 정지하거나 계정을 해지(배제)합니다.
              </li>
              <li>
                본 정책을 위반하여 이용이 정지·해지된 회원은 재가입이 제한될 수 있습니다.
              </li>
            </ol>
          </section>
